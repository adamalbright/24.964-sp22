...
def learn(input_filename, constraints_filename='', initial_markedness_ranking=10, initial_faithfulness_ranking=0, initial_pos_faithfulness_ranking=5, initial_default_ranking=0, number_of_learning_trials=5000, initial_plasticity=.1, plasticity_decrement=0, rankings_file_interval=10, calibration_margin = 1):
...
#			valid_inputfilename = True
	...
	for c in range(0, len(constraint_names)):
		try:
			...
			elif initial_default_rankings[ c ] == 'PosF':
				rankings[c] = initial_pos_faithfulness_ranking
